 ...
 * @author Sony
 */
public class jobEnCours extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cndEnCours.setText("Offre d'emploi ");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jobEnCours.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
