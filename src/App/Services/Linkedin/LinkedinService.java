...
public class LinkedinService {
    ...
    public static int rateLinkedinProfil(Candidates c, String principalSkills, 
           String secondarySkills) throws JSONException, IOException, InterruptedException 
    {
    ...
    public static int rateNbConnection(JSONObject obj,int rate) throws JSONException{
    ...
    public static int rateProjects(JSONObject obj, String[] principalSkillsTab, 
            String[] secondarySkillsTab, int rate) throws JSONException {
    ...
    public static int rateSkills(JSONObject obj,String[] principalSkillsTab,String[] secondarySkillsTab,
            int rate) throws JSONException{
    ...
    public static int ratePrincipalSkills(JSONObject obj,String[] principalSkillsTab,int rate) throws JSONException{
    ...
    public static int rateSecondarySkills(JSONObject obj, String[] secondarySkillsTab,int rate ) throws JSONException {
        JSONArray skills = obj.getJSONArray("skills");
        for (int i = 0; i < skills.length(); i++) {
    ...
    public static int rateProjectsPrincipal(JSONObject obj,String[] principalSkillsTab ,int rate) throws JSONException{
    ...
    public static int rateProjectsSecondary(JSONObject obj,String[] secondarySkillsTab,int rate) throws JSONException{
        JSONArray projects = obj.getJSONArray("projects");
        for(int i=0;i<projects.length();i++){
            for(int j=0; j<secondarySkillsTab.length;j++){
                JSONObject project = projects.getJSONObject(i);
